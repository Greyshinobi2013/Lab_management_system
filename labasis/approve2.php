  ...
  <div class="modal-dialog">
    ...
    <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit"name="approve1" class="btn btn-primary">Approve</button>
      </div>
      </form>
    </div>
  </div>
    ...
    <section class ="content">
        ...
        <div class="card">
                      ...
                      <div class="card-header">
                        ...
                        <a href=""  data-bs-toggle="modal" data-bs-target="#AddUserModal"class="btn btn-primary btn-sm float-right">Student Approve page</a>
