...
function imageUpload($fileName, $path)
{
 $errors = array();
    ...
    $expensions = array("jpeg", "jpg", "png", "pdf","docx","rar","PPt","zip");
...
$sql = "UPDATE `assignment` SET `title`='$title',`description`='$description',`upload_document`='$cFile',`upload_date`='$dates'WHERE ass_id='$id'";
  
   
     $sql1 = mysqli_query($conn,"INSERT INTO activity (date,name,action) VALUES (NOW(),'$ro','update  assignment title $title')");
                            ...
                            <div class="row  justify-content-center">
                                ...
                                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <?php echo $rr['assesment_name']?></option>
                                          ...
                                          $updt = mysqli_query($conn,"SELECT title,description FROM assignment WHERE ass_id='$id'");
                                          while($rows = mysqli_fetch_array($updt)){
                                            $old_title = $rows[0];
                                            $old_desc =$rows[1];
                                          }
                                    ...
                                    <label  for="title">Assignment Title<span class="required"style="color:red">*</span>
                                        ...
                                        <input type="text" class="form-control" name="title"  value="<?php echo  $old_title ?>" placeholder="title">
                                        </div>


                                        <div class="form-group">
                                        <label for="description" >Description:</label>
                                        <textarea class= "resizable_textarea form-control" rows="4" value="<?php echo $old_desc ?>"  name ="description" id ="description" placeholder="writee Description here...."  > </textarea>
