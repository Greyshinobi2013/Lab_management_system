  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
           ...
           <input type = "text" name="course_code" class ="form-control" placeholder ="Name">
        </div>
        <div class="form-group">
            <label for="">Course name</label>
           <input type = "text" name="name" class ="form-control" placeholder ="Insert course name">
        </div>
     ...
     <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit"name="add_course" class="btn btn-primary">Insert</button>
      </div>
      </form>
    </div>
  </div>
                                        ...
                                        $other=mysqli_query($conn,"SELECT * FROM course");
                                          ...
                                          while ($filter=mysqli_fetch_array($other)) {
                                                ...
                                                <?php
                                                    ...
                                                    echo  '<td> <a href="registered_edite.php?id=' .$filter['co_id'].'"><b  class="btn btn-info btn-sm updatet">update </b>  </a>  ';
